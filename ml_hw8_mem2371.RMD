...
Where/when the data was collected, context, identifying confounders/modifiers
...
The final accuracy of this model is **89.6**. 

The variable that is of the most important is the concentration of cobalt, followed by infant growth score and concentration of vanadium. Income and education are both among the ten most important variables. This suggests that concentrations of some metals and sociodemographic factors are both important when considering risk factors for childhood obesity.
...
- different populations => ICU is potentially very different in terms of patient composition
- unsupervised 
