...
The important features change with inclusion of the other variables; the concentration of cobalt becomes the most important variable. When the additional variables are included, lambda does change from 0.02 to 0.014. The model performance, as evaluated through assessing accuracy, is better in this model than in the model with the excluded variables.
...
diss.matrix = dist(covid.data, method = "euclidean")

# Hierarchical clustering using Complete Linkage
clusters.c = hclust(diss.matrix, method = "complete" )

# Plot the obtained dendrogram
plot(clusters.c, cex = 0.6, hang = -1)
